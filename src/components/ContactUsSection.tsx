...
const FormField = ({
  ...
  const baseClasses = "w-full px-4 py-3 rounded-lg bg-neutral-700 border border-neutral-600 text-white focus:outline-none focus:border-blue-500 transition duration-300";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="animate__animated animate__fadeInLeft">
            ...
            <p className="text-gray-300 mb-8 text-lg">
              Have questions? We're here to help! Reach out to us using the form or
