...
const sampleFAQs: FAQItem[] = [
	{
		...
		answer:
			"Your documents are automatically deleted from our servers after processing. We use enterprise-grade encryption and never store your sensitive information.",
	},
	{
		question: "What file formats are supported?",
		answer:
			"We support PDF, Word, Excel, PowerPoint, JPG, PNG, and many other formats. You can convert between these formats seamlessly.",
	},
	{
		question: "Can I use the service offline?",
		answer:
			"Currently, our service requires an internet connection. However, we're working on a desktop application for offline use.",
	},
	{
		question: "What's the maximum file size?",
		answer:
			"Free users can process files up to 10MB, Pro users up to 100MB, and Enterprise users have unlimited file size support.",
	},
];
