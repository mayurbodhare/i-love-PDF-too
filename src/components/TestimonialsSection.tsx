  ...
  <div className="w-full md:w-1/2 lg:w-1/3 flex-none px-4">
    <div className="bg-neutral-50 p-8 rounded-xl shadow-lg">
      <div className="flex items-center mb-6">
        <div className={`w-14 h-14 rounded-full ${avatarBgColor} flex items-center justify-center`}>
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      initials: 'JD',
      comment: 'This tool has revolutionized how we handle documents. The compression feature alone has saved us gigabytes of storage!',
    ...
    },
    {
      ...
      initials: 'AS',
      comment: 'The OCR functionality is incredibly accurate. It\'s saved me countless hours of manual data entry.',
    ...
    },
    {
      ...
      initials: 'MJ',
      comment: 'The merge and split features are intuitive and perfect for handling large documents. Highly recommended!',
      avatarBgColor: 'bg-purple-600',
    },
  ];

  const { currentIndex, nextSlide, prevSlide } = useAutoSlide(testimonials.length);
        ...
        <div className="relative testimonial-slider">
          <div className="overflow-hidden">
            <div 
              ...
              style={{ transform: `translateX(-${currentIndex * trackWidth}px)` }}
            >
